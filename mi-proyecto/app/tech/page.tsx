    ...
    <div className="w-full flex flex-col items-center py-20 px-6">
      ...
      <header className="text-center mb-20 max-w-4xl mx-auto">
        ...
        <p className="text-xl text-gray-400 max-w-2xl mx-auto font-light leading-relaxed">
          Haz clic en cualquier tecnología para explorar un análisis técnico más profundo sobre su arquitectura y casos de uso.
        </p>
      </header>
      ...
      <section className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto w-full">
        ...
        <Link href="/tech/nextjs" className="relative group block outline-none">
          ...
          <div className="relative h-full rounded-[1.4rem] bg-[#0a0a0a] border border-gray-800 p-8 flex flex-col items-center text-center transition-transform duration-300 group-hover:-translate-y-2 group-hover:scale-[1.02]">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Creación de Landing Pages, E-commerce y Web Apps ultra rápidas con renderizado en el servidor (SSR) y generación estática (SSG).
            </p>
          </div>
        </Link>

        {/* React Card */}
        <Link href="/tech/react" className="relative group block outline-none">
          ...
          <div className="relative h-full rounded-[1.4rem] bg-[#0a0a0a] border border-gray-800 p-8 flex flex-col items-center text-center transition-transform duration-300 group-hover:-translate-y-2 group-hover:scale-[1.02]">
            <div className="w-16 h-16 bg-[#61dafb]/10 border border-[#61dafb]/20 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
              <ReactIcon className="w-10 h-10" />
            </div>
            <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-lime-400 transition-colors">React</h3>
            <p className="text-gray-400 text-sm leading-relaxed">
        ...
        {/* React Native Card */}
        <Link href="/tech/react-native" className="relative group block outline-none">
          ...
          <div className="relative h-full rounded-[1.4rem] bg-[#0a0a0a] border border-gray-800 p-8 flex flex-col items-center text-center transition-transform duration-300 group-hover:-translate-y-2 group-hover:scale-[1.02]">
            <div className="w-16 h-16 bg-lime-500/10 border border-lime-500/20 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
            ...
            <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-lime-400 transition-colors">React Native</h3>
            <p className="text-gray-400 text-sm leading-relaxed">
              Desarrollo de aplicaciones nativas y multiplataforma para iOS y Android compartiendo base de código de manera óptima.
            </p>
          </div>
        </Link>
        ...
        <Link href="/tech/nodejs" className="relative group block outline-none">
          ...
          <div className="relative h-full rounded-[1.4rem] bg-[#0a0a0a] border border-gray-800 p-8 flex flex-col items-center text-center transition-transform duration-300 group-hover:-translate-y-2 group-hover:scale-[1.02]">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Arquitecturas robustas, escalables y seguras en el servidor. Desarrollo de APIs y bases de datos optimizadas para manejar grandes volúmenes.
            </p>
          </div>
        </Link>
