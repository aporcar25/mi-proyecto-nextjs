...
export default function Navbar() {
  ...
  return (
    <nav className="fixed w-full top-0 z-50 bg-[#050505]/80 backdrop-blur-md border-b border-gray-800/50">
      <div className="max-w-7xl mx-auto px-6 py-8 flex items-center justify-between h-auto min-h-[5rem]">
        ...
        <Link href="/contact" className="px-5 py-3 bg-lime-400 hover:bg-lime-500 text-black font-bold rounded-full transition-all hover:shadow-[0_0_20px_rgba(163,230,53,0.4)] text-sm">
          Hablemos
        </Link>
      </div>
    </nav>
